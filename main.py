...
df = pd.read_csv(r"E:\rv\whitehatjr\multi language\data-pre-processing\data_cleaning\final.csv")
...
df.to_csv(r'E:\rv\whitehatjr\multi language\data-pre-processing\data_cleaning\main.csv')
